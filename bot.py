...
class SetupBot(commands.Cog):
    ...
    async def setup(self, interaction: discord.Interaction) -> None:
        ...
        if interaction.user.id != interaction.guild.owner_id:
            embed = discord.Embed(
                title="❌ Access Denied",
                description="Only the server owner can use this bot.",
    ...
    async def info(self, interaction: discord.Interaction) -> None:
        # /info is viewable by everyone, just shows information
        ...
        embed.add_field(
            ...
            value="**⚠️ OWNER ONLY**\nOnly the server creator/owner can use this bot's commands for security and safety.",
            inline=False
        )
        ...
        embed.add_field(
            ...
            value=(
                ...
                "• **Channel Permissions** - Use Discord settings directly\n"
                "• **Role Permissions** - Review what each role can do\n"
                "• **Channel Order** - Use `/priority` to organize categories\n"
                "• **Channel Names** - Rename in Discord settings if needed\n"
                "• **Channel Topics** - Add descriptions in Discord settings\n\n"
