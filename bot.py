...
class TemplateSelect(discord.ui.Select):
    ...
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        options = [
            discord.SelectOption(name="Gaming", value="Gaming", emoji="🎮"),
            discord.SelectOption(name="Community", value="Community", emoji="👥"),
            discord.SelectOption(name="Content Creator", value="Content Creator", emoji="🎬"),
            discord.SelectOption(name="Business", value="Business", emoji="💼"),
            discord.SelectOption(name="Minecraft", value="Minecraft", emoji="⛏️"),
        ]
...
class TemplateSelectView(discord.ui.View):
    ...
    def __init__(self, bot: commands.Bot):
        super().__init__()
        self.add_item(TemplateSelect(bot))
