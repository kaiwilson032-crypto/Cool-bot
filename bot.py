    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            embed = discord.Embed(
                ...
                description=f"**{self.category.name}** → Priority {priority_val}",
                color=discord.Color.green()
            )
            
            embed.add_field(name="Level", value=priority_text[priority_val], inline=True)
